...
void drawHit()
{
    ...
    if(direction == UP)
    {
        for(int i = 0; i < spacing / 2 && pos.yCoords[0] > spacing ; i += moveDistance, distanceFromBorder += moveDistance)
        {
        ...
        for(int i = 0; i < distanceFromBorder; i += moveDistance)
        {
            pos.centerY = pos.centerY + moveDistance;  
            update();
            sleep(15); 
    ...
    {
        for(int i = 0; i < spacing / 2 && pos.yCoords[0] < HEIGHT - spacing; i += moveDistance, distanceFromBorder += moveDistance)
        {
            pos.centerY = pos.centerY + moveDistance;
    ...
    {
        for(int i = 0; i < spacing / 2 && pos.xCoords[0] > spacing; i += moveDistance, distanceFromBorder+= moveDistance)
        {
    ...
    {
        for(int i = 0; i < spacing / 2 && pos.xCoords[0] < WIDTH - spacing; i += moveDistance, distanceFromBorder+= moveDistance)
        {
            pos.centerX = pos.centerX + moveDistance;
